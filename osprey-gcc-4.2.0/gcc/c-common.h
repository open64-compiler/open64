...
enum rid
{
  ...
  /* C11 extended */
  RID_NORETURN, RID_STATIC_ASSERT,
  ...
  RID_DFLOAT32, RID_DFLOAT64, RID_DFLOAT128, RID_FLOAT128,

  /* KEIL and IAR common extensions */
  RID_INTADDR, RID_PACKED,  RID_WEAK,

  /* KEIL extensions */
  RID_ALIGN,   RID_GLOBAL_REG, RID_INT64,    RID_IRQ,
  RID_PURE,    RID_SOFTFP,     RID_SMC,   RID_SVC,
  RID_VALUE_IN_REGS,           RID_WRITEONLY,

  /* IAR extensions */
  RID_ARM,
  RID_CODE24,   RID_CODE32,   RID_CONSTRANGE,
  RID_DATA16,   RID_DATA24,   RID_DATA32,
  RID_INTERRUPT,RID_INTERWORK,RID_INTRINSIC,
  RID_MONITOR,  RID_NO_INIT,  RID_NONSECURE_CALL, RID_NONSECURE_ENTRY,
  RID_NOUNWIND, RID_RAMFUNC,  RID_ROOT,
  RID_SBDATA16, RID_SBDATA24, RID_SFB,         RID_SFE,
  RID_SPEC_STRING, RID_SWI,
  RID_TASK,     RID_THUMB,
