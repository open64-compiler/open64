...
typedef enum gsbi {
  ...
  GSBI_BUILT_IN_BSWAP16,
  GSBI_BUILT_IN_BSWAP32,
  GSBI_BUILT_IN_BSWAP64,
...
#endif
  GSBI_BUILT_IN_FPCLASSIFY,
  GSBI_BUILT_IN_ISFINITE,
  GSBI_BUILT_IN_ISINF_SIGN,
  ...
  GSBI_BUILT_IN_VA_ARG_PACK,
  GSBI_BUILT_IN_VA_ARG_PACK_LEN,
