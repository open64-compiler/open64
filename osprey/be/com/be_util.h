 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/be/com/SCCS/s.be_util.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *be_utilrcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/be/com/SCCS/s.be_util.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
