...
TAS_To_TOP(WN *tas_wn)
{
    ...
    case OPC_I8TAS:
    case OPC_U8TAS:
        return MTYPE_float(kid_mtype) ? TOP_dmfc1 : TOP_nop;
    case OPC_I4TAS:
    case OPC_U4TAS:
        return MTYPE_float(kid_mtype) ? TOP_mfc1 : TOP_nop;
    case OPC_F8TAS:
        DevWarn("Handle TAS from int to F8!");
        return MTYPE_float(kid_mtype) ? TOP_nop : TOP_dmtc1;
    case OPC_F4TAS:
        DevWarn("Handle TAS from int to F4!");
        return MTYPE_float(kid_mtype) ? TOP_nop : TOP_mtc1;
    default:
        return TOP_UNDEFINED;
    }
}
