...
PUBLIC
  ...
  ENUM_BEGIN(EXEC_KIND)
    ...
    ENUMERATOR(EXEC_KIND,PRE_CHECK_VAR,632)
    ENUMERATOR(EXEC_KIND,PRE_CHECK_VAR_VALUE,633)
  ...
  */
  ...
  PUB_MOD STATIC RBC_BOOL   Pre_check_var_value(OBJECT v, RBC_CONST RBC_STRING opr, OBJECT value) BOOL_BODY;
  ...
  */
  ...
  PUB_MOD STATIC RBC_BOOL   Is_null_term_set(OBJECT var) BOOL_BODY;
