...
foreach(ONE_C_FILE IN LISTS FE_C_SRCS )
  get_osprey_file_path(${ONE_C_FILE} ${WGEN_DIR} WGEN_SRC)
endforeach()
...
foreach(ONE_C_FILE IN LISTS COMMON_COM_CXX_SRCS )
  get_osprey_file_path(${ONE_C_FILE} ${COMMON_COM_DIR} WGEN_SRC)
endforeach()

foreach(ONE_C_FILE IN LISTS COMMON_COM_TARG_SRCS )
  get_osprey_file_path(${ONE_C_FILE} ${COMMON_COM_DIR}/${BUILD_TARGET_PREFIX} WGEN_SRC)
endforeach()
...
foreach(ONE_C_FILE IN LISTS WGENUTIL_O_CXX_SRC)
  get_osprey_file_path(${ONE_C_FILE} ${COMMON_COM_DIR} WGENUTILO_SRC)
endforeach()  
