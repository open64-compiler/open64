...
WN_PRAGMA_DESC WN_pragmas[] = {
    ...
    {(WN_PRAGMA_USERS)(PUSER_IPA | PUSER_WOPT), WN_PRAGMA_SCOPE_ON,
     "INLINE_BODY_START"},
    {(WN_PRAGMA_USERS)(PUSER_IPA | PUSER_WOPT), WN_PRAGMA_SCOPE_OFF,
     "INLINE_BODY_END"},
    ...
    {PUSER_PURPLE, (WN_PRAGMA_SCOPE)WN_PRAGMA_PURPLE_CONDITIONAL,
     "PURPLE_CONDITIONAL"},
    {PUSER_PURPLE, (WN_PRAGMA_SCOPE)WN_PRAGMA_PURPLE_UNCONDITIONAL,
     "PURPLE_UNCONDITIONAL"},
    ...
    {PUSER_LNO, WN_PRAGMA_SCOPE_PU,
     "KAP_ASSERT_TEMPORARIES_FOR_CONSTANT_ARGUMENTS"},
    {PUSER_LNO, WN_PRAGMA_SCOPE_PU,
     "KAP_ASSERT_NOTEMPORARIES_FOR_CONSTANT_ARGUMENTS"},
    ...
    {PUSER_MP, WN_PRAGMA_SCOPE_POINT,
     "PARALLEL_WORKSHARE"},                               /* by jhs, 04.3.10 */
