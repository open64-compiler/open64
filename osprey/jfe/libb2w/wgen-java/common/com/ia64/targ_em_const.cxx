 ...
 * $Author: marcel $
 * $Source:
 * /proj/osprey/CVS/open64/osprey1.0/common/com/ia64/targ_em_const.cxx,v $
 *
 * Revision history:
                     ...
                     INTSC loc)     /* Location (i.e. offset from some base) */
{
  ...
  while (rc) {
    ...
    case MTYPE_I2:
    case MTYPE_U2:
      Emit_Repeated_Constant(fl, ((loc % 2) == 0 ? AS_HALF : AS_HALF_UNALIGNED),
    ...
    case MTYPE_I4:
    case MTYPE_U4:
      Emit_Repeated_Constant(fl, ((loc % 4) == 0 ? AS_WORD : AS_WORD_UNALIGNED),
                             TCON_v0(tc), rc, 4);
      rc = 0;
      break;
