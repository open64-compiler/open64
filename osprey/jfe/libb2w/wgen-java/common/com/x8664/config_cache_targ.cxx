...
void MHD::Initialize() {
  ...
  case TARGET_anyx86:
    ...
    L[1] = MHD_LEVEL(MHD_TYPE_CACHE, 1 * 1024 * 1024, 64, 150,
                     200, // ?
                     16, 512, 4 * 1024,
                     50,                            // ?
                     50,                            // ?
  ...
  case TARGET_athlon:
    // TODO: this might be too generous: in multiple processor situations,
    // there is a cost to loading the shared bus/memory.
    L[1] = MHD_LEVEL(MHD_TYPE_CACHE, 1 * 512 * 1024, 64, 103,
                     103, // ?
                     16, 256, 4 * 1024,
                     52,                            // ?
                     52,                            // ?
  ...
  case TARGET_pentium4:
  case TARGET_xeon:
    L[1] = MHD_LEVEL(MHD_TYPE_CACHE, 1 * 1024 * 1024, 64, 103,
                     103, // ?
                     16, 256, 4 * 1024,
                     52,                            // ?
                     52,                            // ?
  ...
  case TARGET_em64t:
    ...
    break;
  case TARGET_core:
    L[1] = MHD_LEVEL(MHD_TYPE_CACHE, 4 * 1024 * 1024,
                     64,                            // ?
                     150,                           // ?
                     200,                           // ?
                     16,                            // ?
  ...
  if (LNO_Verbose)
    printf("Target Processor: %s. %lld (%d), %lld (%d)\n", Targ_Name(Target),
           L[0].Effective_Size, L[0].Line_Size, L[1].Effective_Size,
           L[1].Line_Size);
#endif
}
