...
static OPTION_DESC Options_LIST[] = {
    ...
    {OVK_BOOL, OV_VISIBLE, FALSE, "", "", 0, 0, 0, &List_Enabled, NULL,
     "Enable listing file (.l) generation"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "all_options", "al", 0, 0, 0,
     &List_All_Options, NULL, "List all options in listing file"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "cite", "ci", 0, 0, 0, &List_Cite, NULL,
     "List CITE information in listing file"},

    {OVK_BOOL, OV_INTERNAL, FALSE, "efile", "ef", 0, 0, 0, &Err_File_Name, NULL,
     "Specify listing file name instead of <base>.l"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "options", "op", 0, 0, 0, &List_Options, NULL,
     "List set/modified options in listing file"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "notes", "no", 0, 0, 0, &List_Notes,
     &List_Notes_Set, "Put compiler notes in .s file"},

    {OVK_BOOL, OV_INTERNAL, FALSE, "source", "so", 0, 0, 0, &List_Source, NULL,
     "Intersperse source code in .s file"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "symbols", "sy", 0, 0, 0, &List_Symbols, NULL,
     "List symbols in listing file"},

    {OVK_BOOL, OV_VISIBLE, FALSE, "software_names", "soft", 0, 0, 0,
     &List_Software_Names, NULL,
