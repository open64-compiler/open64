 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/common/util/bitset.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *xxx_rcs_id = "$Source: /proj/osprey/CVS/open64/osprey1.0/common/util/bitset.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
