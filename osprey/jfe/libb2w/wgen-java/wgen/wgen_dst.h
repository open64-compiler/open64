...
#ifdef _KEEP_RCS_ID
static char *wfe_dst_rcs_id =
    "$Source: kg++fe/SCCS/s.wfe_dst.h $ $Revision: 1.10 $";
#endif /* _KEEP_RCS_ID */
...
extern void DST_build(int num_copts,  /* Number of options passed to fec(c) */
...
extern DST_INFO_IDX Create_DST_type_For_Tree(gs_t type_tree, TY_IDX ttidx,
                                             TY_IDX idx,
                                             bool ignoreconst = false,
                                             bool ignorevolatile = false);
extern DST_INFO_IDX Create_DST_decl_For_Tree(gs_t decl_node, ST *var_st);
...
extern void WGEN_Set_Line_And_File(unsigned int line, const char *file,
                                   bool check = false);
#ifdef KEY
