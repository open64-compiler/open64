...
TYPE_ID FE_Pointer_Type_To_Mtype(void) { return CIM_pointer(Target_Int_Model); }

TYPE_ID FE_int_To_Mtype(void) { return CIM_int(Target_Int_Model); }

void Make_Int_Model_Consistent(void) {
  Use_32_Bit_Pointers = MTYPE_size_reg(CIM_pointer(Target_Int_Model)) == 32;
}
