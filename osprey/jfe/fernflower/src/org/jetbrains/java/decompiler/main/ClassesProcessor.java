...
import org.jetbrains.java.decompiler.modules.b2w.TreeVisitor;
...
public class ClassesProcessor {
  ...
  public void writeClass(StructClass cl, TextBuffer buffer) throws IOException {
    ConsoleDecompiler.l.traceEntry();
    ConsoleDecompiler.l.info("###### generate java code to buffer ######");
  ...
  private void generateWHIRL(StructClass cl) {
    TreeVisitor visitor = new TreeVisitor(mapRootClasses);
    visitor.visitStructClass(cl);
  }
