...
QUAD c_q_add(QUAD a, QUAD b, int *c)
{
   float128 *pa = (float128 *)&a;
   float128 *pb = (float128 *)&b;
   float128 res = float128_add(*pa, *pb);
   *c = 0;
   QUAD *pres = (QUAD*)&res;
   return *pres;
}
...
QUAD c_q_sub(QUAD a, QUAD b, int *c)
{
   float128 *pa = (float128 *)&a;
   float128 *pb = (float128 *)&b;
   float128 res = float128_sub(*pa, *pb);
   *c = 0;
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
QUAD c_q_mul(QUAD a, QUAD b, int *c)
{
   float128 *pa = (float128 *)&a;
   float128 *pb = (float128 *)&b;
   float128 res = float128_mul(*pa, *pb);
   *c = 0;
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
QUAD c_q_div(QUAD a, QUAD b, int *c)
{
   float128 *pa = (float128 *)&a;
   float128 *pb = (float128 *)&b;
   float128 res = float128_div(*pa, *pb);
   *c = 0;
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
INT32 c_ji_qint(QUAD a, int *p_err )
{
   float128 *pa = (float128 *)&a;
   return float128_to_int32(*pa);
}

#pragma weak c_ji_quint = __c_ji_quint
#define	c_ji_quint __c_ji_quint
UINT32 c_ji_quint(QUAD a, int *p_err )
{
   return 0;
}
...
INT64 c_ki_qint(QUAD a, int *p_err )
{
   float128 *pa = (float128 *)&a;
   return float128_to_int64(*pa);
}

#pragma weak c_ki_quint = __c_ki_quint
#define	c_ki_quint __c_ki_quint
UINT64 c_ki_quint(QUAD a, int *p_err )
{
   return 0;
}
...
float c_sngl_q(QUAD a, int *p_err )
{
   float128 *pa = (float128 *)&a;
   float32 res = float128_to_float32(*pa);
...
double c_dble_q(QUAD a, int *p_err )
{
   float128 *pa = (float128 *)&a;
   float64 res = float128_to_float64(*pa);
   double *pres = (double *)&res;
   return *pres;
}
...
{
   float128 res = int32_to_float128(n);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
{
   float128 res = int64_to_float128(n);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
QUAD c_q_ext( float a, int *p_err )
{
   float32 *pa = (float32 *)&a;
   float128 res = float32_to_float128(*pa);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
QUAD c_q_extd(double a, int *p_err )
{
   float64 *pa = (float64 *)&a;
   float128 res = float64_to_float128(*pa);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
QUAD c_q_trunc(QUAD a, int *p_err )
{
   float128 *pa = (float128 *)&a;
   float128 res = float128_round_to_int(*pa);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
{
   float128 *px = (float128 *)&x;
   float128 res = float128_sqrt(*px);
   QUAD *pres = (QUAD *)&res;
   return *pres;
}
...
INT c_q_lt(QUAD x, QUAD y, INT *p_err )
{
   float128 *px = (float128 *)&x;
   float128 *py = (float128 *)&y;
   return float128_lt(*px, *py);
}
...
INT c_q_le(QUAD x, QUAD y, INT *p_err )
{
   float128 *px = (float128 *)&x;
   float128 *py = (float128 *)&y;
   return float128_le(*px, *py);
}

#pragma weak c_q_eq = __c_q_eq
#define	c_q_eq __c_q_eq
INT c_q_eq(QUAD x, QUAD y, INT *p_err )
{
   float128 *px = (float128 *)&x;
   float128 *py = (float128 *)&y;
   return float128_eq(*px, *py);
}

#pragma weak c_q_ne = __c_q_ne
#define	c_q_ne __c_q_ne
INT c_q_ne(QUAD x, QUAD y, INT *p_err )
{
   float128 *px = (float128 *)&x;
   float128 *py = (float128 *)&y;
   if (float128_eq(*px, *py)) return 0;
   return 1;
}

#pragma weak c_q_gt = __c_q_gt
#define	c_q_gt __c_q_gt
INT c_q_gt(QUAD x, QUAD y, INT *p_err )
{
   float128 *px = (float128 *)&x;
   float128 *py = (float128 *)&y;
   if (float128_le(*px, *py)) return 0;
   return 1;
}
