...
#endif // TARG_SL
#ifdef DYNAMICLANG
  { MTYPE_DYNANY, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNANY", MTYPE_CLASS_DYNAMIC, 33, MTYPE_DYNANY },
  { MTYPE_DYNUNDEF, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNUNDEF", MTYPE_CLASS_DYNAMIC, 33, MTYPE_DYNUNDEF },
  { MTYPE_DYNNULL, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNNULL", MTYPE_CLASS_DYNAMIC, 33, MTYPE_DYNNULL },
  { MTYPE_DYNBOOL, 1, 0, 0, 0, 0, 0, 0, 0, 0, "DYNBOOL", MTYPE_CLASS_DYNAMIC|MTYPE_CLASS_INTEGER, 33, MTYPE_DYNBOOL },
  { MTYPE_DYNI4, 32, 32, 32, 4, 4, 4, 1, 0, 0, "DYNI4", MTYPE_CLASS_DYNAMIC|MTYPE_CLASS_INTEGER, 33, MTYPE_DYNI4 },
  { MTYPE_DYNSTR, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNSTR", MTYPE_CLASS_DYNAMIC|MTYPE_CLASS_STR, 33, MTYPE_DYNSTR },
  { MTYPE_DYNOBJ, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNOBJ", MTYPE_CLASS_DYNAMIC, 33, MTYPE_DYNOBJ },
  { MTYPE_DYNF4, 32, 32, 32, 4, 4, 4, 0, 1, 0, "DYNF4", MTYPE_CLASS_DYNAMIC|MTYPE_CLASS_FLOAT, 33, MTYPE_DYNF4 },
  { MTYPE_DYNF8, 64, 64, 64, 8, 8, 8, 0, 1, 0, "DYNF8", MTYPE_CLASS_DYNAMIC|MTYPE_CLASS_FLOAT, 33, MTYPE_DYNF8 },
  { MTYPE_DYNNONE, 64, 64, 64, 8, 8, 8, 0, 0, 0, "DYNNODE", MTYPE_CLASS_DYNAMIC, 33, MTYPE_DYNNONE }
#endif
};
