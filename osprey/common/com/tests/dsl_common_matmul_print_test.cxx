...
Create_Common_Matmul_Test_Tree(WN **dsl_marker_out)
{
    ...
    DSL_FIXTURE_VALUE tensor_one_kid0 =
	DSL_Fixture_Create_Tensor_Const ("tensor_one_kid0",
					 "tensor_one_kid0_type",
					 "int32",
					 2,
					 "[2,2]",
					 "row_major",
					 "1");
    DSL_FIXTURE_VALUE tensor_one_kid1 =
	DSL_Fixture_Create_Tensor_Const ("tensor_one_kid1",
					 "tensor_one_kid1_type",
					 "int32",
					 2,
					 "[2,2]",
					 "row_major",
					 "1");
    WN *dsl_marker = DSL_Fixture_Create_Common_Matmul (&tensor_one_kid0,
						       &tensor_one_kid1);

    if (dsl_marker_out != NULL)
        *dsl_marker_out = dsl_marker;

    WN_INSERT_BlockLast(block, tensor_one_kid0.value);
    WN_INSERT_BlockLast(block, tensor_one_kid1.value);
