...
#define TWO64 (0)
  ...
  ISA_Create_Lit_Class("i26", SIGNED, SignedBitRange(26), LIT_RANGE_END);
  ...
  ISA_Create_Lit_Class("i48", SIGNED, SignedBitRange(48), LIT_RANGE_END);
  ...
  ISA_Create_Lit_Class("k16", UNSIGNED, UnsignedBitRange(16), LIT_RANGE_END);
  ISA_Create_Lit_Class("k20", UNSIGNED, UnsignedBitRange(20), LIT_RANGE_END);
  ...
  ISA_Create_Lit_Class("k24", UNSIGNED, UnsignedBitRange(24), LIT_RANGE_END);
   ISA_Create_Lit_Class("k32", UNSIGNED, UnsignedBitRange(32), LIT_RANGE_END);
  ISA_Create_Lit_Class("k48", UNSIGNED, UnsignedBitRange(48), LIT_RANGE_END);
  ISA_Create_Lit_Class("k62", UNSIGNED, UnsignedBitRange(62), LIT_RANGE_END);
  ISA_Create_Lit_Class("k64", UNSIGNED, UnsignedBitRange(64), LIT_RANGE_END);
