...
#ifndef INT_MAX         //TOOK THIS OFF OF ROSA'S CODE
...
protected:
   UInt_t   fBits;//BIT FIELD STATUS WORD... FROM ROSA'S CODE. ORIGIN: TObject.h
   ...
   enum EMatrixStatusBits {    //THIS IS PUBLIC IN ROSA'S CODE
...
// virtual void   Clear      (Option_t *option="") = 0;
   ...
   //KEVIN: TAKEN FROM TOBJECT.H, THESE WERE IN ROSA'S CODE AS WELL... NECESSARY FOR ABOVE FUNCTIONS TO WORK
