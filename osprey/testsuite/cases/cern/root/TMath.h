...
inline   Long64_t  LocMin(Long64_t n, const Int_t *a){
   if  (n <= 0 || !a) return -1;
   Int_t xmin = a[0];
   Long64_t loc = 0;
 ...
 inline  Long64_t  LocMax(Long64_t n, const Int_t *a){
   ...
   Long64_t BinarySearch(Long64_t n, const Float_t **array,  Float_t value);
  inline Long64_t BinarySearch(Long64_t n, const Double_t *array,  Double_t value)
   {
