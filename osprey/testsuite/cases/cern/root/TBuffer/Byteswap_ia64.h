...
R__bswap_16 (unsigned short int __bsx)
{
  return R__bswap_constant_16 (__bsx);
}
#endif
...
R__bswap_32 (unsigned int __bsx)
{
  return R__bswap_constant_32 (__bsx);
}
#endif


/* Swap bytes in 64 bit value.  */
#define R__bswap_constant_64(x) \
...
R__bswap_64 (unsigned long int __bsx)
{
