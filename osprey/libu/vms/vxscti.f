...
C
      ...
      SUBROUTINE VXSCTI(FPN,DEST,ISB,NUM,IER,INC)
C
C     The VXSCTI subroutine converts Cray 64-bit single-precision
C     floating-point numbers to VAX F_format single-precision
...
CDIR$ SHORTLOOP
   ...
   80 CONTINUE
      ...
      CALL VXMOVE00(JTEMP,1,NUMP*4,DEST,JSB)
      ...
      RETURN
CDIR$ ID "@(#) libu/vms/vxscti.f	92.0	10/08/98 14:57:41"
      END
