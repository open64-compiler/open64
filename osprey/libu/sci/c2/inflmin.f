...
C
       ...
       integer function inflmin( n, ix, inc, mask, shift )
       integer n, inc, mask, shift
       integer ix( * )

*..... Local Variables
       integer i, j, val, min, index
...
*     USM What Line
*     -------------
CDIR$ ID "@(#) libu/sci/c2/inflmin.f	92.0	10/08/98 14:57:41"
...
30         format( ' ** On entry to INFLMAX, INC was nonpositive.')
         ...
         min = and( shiftr( ix( 1 ), shift ), mask )
         index = 1
         j = 1 + inc
         do 40 i = 2, n
