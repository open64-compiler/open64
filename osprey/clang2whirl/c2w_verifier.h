...
#ifndef CLANG2WHIRL_VERIFIER_H
#define CLANG2WHIRL_VERIFIER_H

#define DBG_VERIFY_WHIRL_IR(wn) WN_verifier(wn)
#define DBG_VERIFY_WHIRL_SYM()


#endif /* CLANG2WHIRL_VERIFIER_H */
