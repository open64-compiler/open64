...
C
      ...
      subroutine COUNT_W_LS5@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,hi4,
     +                      low4,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_s5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LS5@.
*
...
*                      dimension dim.
*
* Variables: local_cnt - integer array of rank 4: array of local count
*                      of true elements.
...
*
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_cnt(i1,i2,i3,i4) = 0
      enddo
      enddo
      enddo
      enddo
*
      include "count_w_5@.fh"
*
      return
      end
