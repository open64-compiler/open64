...
C
      ...
      subroutine MAXLOC_JS6@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_s_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer result(0:0,6), maskflg, ext(6), local_idx(6)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(6), max_value(0:0), in_parallel
...
*
      ...
      subroutine MAXLOC_SS6@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
************************************************************************
      ...
      real local_max, far_max, max_value(0:0)
      real HUGE_FLT
*
cdir$ unknown_shared source, mask
*
...
*
      ...
      subroutine MAXLOC_NM_JS6@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:0,6), ext(6), local_idx(6)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(6), max_value(0:0), in_parallel
      integer source(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6))
...
*
      local_max = -HUGE_INT()
      include "maxloc_nomask_6@.fh"
*
      return
      end


      subroutine MAXLOC_NM_SS6@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
