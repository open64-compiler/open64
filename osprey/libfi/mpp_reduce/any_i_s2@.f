...
C
      ...
      subroutine ANY_I_LS2@(result,source,dim,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_i_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ANY_LS2.
*
...
*                      distributed block in each dimension.
*            lmext   - integer scalar: extent of the local-any array
...
*
      include "setup_2@.fh"
*
      call ANY_W_LS2@(result,source,dim,rext,loc_sext,
