...
C
      ...
      subroutine SUM_I_JP3@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/sum_i_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      include "setup_3@.fh"
*
      call SUM_W_JP3@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine SUM_I_SP3@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Compute the sum of the elements identified by mask.
...
*
      include "setup_3@.fh"
*
      call SUM_W_SP3@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi_r1,low_r1,hi_r2,low_r2,lmext,
     +                 dist_cnt)
*
      return
