...
C
      ...
      subroutine MINVAL_I_JS7@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_i_s7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      include "setup_7@.fh"
*
      call MINVAL_W_JS7@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine MINVAL_I_SS7@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Find the minimum value of the elements identified by
...
*
      include "setup_7@.fh"
*
      call MINVAL_W_SS7@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi_r1,low_r1,hi_r2,low_r2,hi_r3,
     +                 low_r3,hi_r4,low_r4,hi_r5,low_r5,hi_r6,low_r6,
     +                 lmext,dist_cnt)
*
