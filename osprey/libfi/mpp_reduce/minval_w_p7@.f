...
C
      ...
      subroutine MINVAL_W_JP7@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,hi6,low6,lmext,
     +                   dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_w_p7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            the Fortran routine MINVAL_I_JP7@.
*
...
cdir$ doshared (i6,i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5,i6)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4,i5,i6) = HUGE_INT()
      enddo
      enddo
      enddo
      enddo
      ...
      enddo
*
      include "minval_w_7@.fh"
*
      return
      end


      subroutine MINVAL_W_SP7@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,hi6,low6,lmext,
     +                   dist_cnt)
************************************************************************
...
*            mask. This routine handles integer source arrays of rank
*            7. It returns an array result. This routine is called by
*            the Fortran routine MINVAL_I_SP7@.
*
...
cdir$ doshared (i6,i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5,i6)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4,i5,i6) = HUGE_FLT()
      enddo
      enddo
      enddo
      enddo
