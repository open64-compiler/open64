...
C
      ...
      subroutine COUNT_W_LS2@(result,source,dim,rext,sext,blkcnt,
     +                      npes,hi,low,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LS2@.
*
...
*                      extent of the local_cnt array if called within
...
*                      dimension dim.
*
* Variables: local_cnt - integer array of rank 1: array of local count
*                      of true elements.
...
************************************************************************
      ...
      integer result(rext), local_cnt(lmext)
