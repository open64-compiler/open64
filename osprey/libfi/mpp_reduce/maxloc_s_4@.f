...
C
      ...
      subroutine MAXLOC_JS4@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_s_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer max_value(0:0), source(ext(1),ext(2),ext(3),ext(4))
      integer HUGE_INT
...
*
      ...
      subroutine MAXLOC_SS4@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx(4)
      logical mask(ext(1),ext(2),ext(3),ext(4)), in_parallel
      real max_value(0:0), source(ext(1),ext(2),ext(3),ext(4))
...
*
      ...
      subroutine MAXLOC_NM_JS4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
*
      ...
      subroutine MAXLOC_NM_SS4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
