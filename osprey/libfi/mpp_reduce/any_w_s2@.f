...
C
      ...
      subroutine ANY_W_LS2@(result,source,dim,rext,sext,blkcnt,
     +                      npes,hi,low,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_w_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ANY_I_LS2@.
*
...
*                      extent of the local_any array if called within
...
*                      dimension dim.
*
* Variables: local_any - logical array of rank 1: array of local any
*                      values.
...
************************************************************************
      ...
      logical result(rext), local_any(lmext)
