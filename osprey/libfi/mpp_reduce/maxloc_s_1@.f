...
C
      ...
      subroutine MAXLOC_JS1@(fresult,source,mask,maskflg,extent)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_s_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer max_value(0:0), source(extent), local_max, far_max
      integer HUGE_INT
*
...
*
      ...
      subroutine MAXLOC_SS1@(fresult,source,mask,maskflg,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx
      logical mask(extent), in_parallel
      real max_value(0:0), source(extent), local_max, far_max
      real HUGE_FLT
*
cdir$ unknown_shared source, mask
*
...
*
      ...
      subroutine MAXLOC_NM_JS1@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
*
      ...
      subroutine MAXLOC_NM_SS1@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
