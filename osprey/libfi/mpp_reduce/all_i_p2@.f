...
C
      ...
      subroutine ALL_I_LP2@(result,source,dim,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_i_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ALL_LP2.
*
...
*                      distributed block in each dimension.
*            lmext   - integer scalar: extent of the local-all array
...
************************************************************************
      ...
      integer blkcnts(2), npes, mype, dist_cnt
      integer dim, dim_bcnt
...
*
      include "setup_2@.fh"
*
      call ALL_W_LP2@(result,source,dim,rext,loc_sext,
