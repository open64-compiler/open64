...
C
      ...
      subroutine SUM_W_JS5@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/sum_w_s5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine SUM_I_JS5@.
*
...
*
      ...
      subroutine SUM_W_SS5@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,lmext,dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            5. It returns an array result. This routine is called
*            by the Fortran routine SUM_I_SS5@.
*
