...
C
      ...
      subroutine ANY_W_LS5@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,hi4,
     +                      low4,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_w_s5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ANY_I_LS5@.
*
...
*                      dimension dim.
*
* Variables: local_any - logical array of rank 4: array of local any values.
