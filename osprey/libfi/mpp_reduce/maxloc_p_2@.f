...
C
      ...
      subroutine MAXLOC_JP2@(fresult,source,mask,maskflg,extent)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_p_2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer max_value(0:n$pes-1), source(extent(1),extent(2))
...
*
      ...
      subroutine MAXLOC_SP2@(fresult,source,mask,maskflg,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx(2)
      logical mask(extent(1),extent(2)), in_parallel
      real max_value(0:n$pes-1), source(extent(1),extent(2))
...
*
      ...
      subroutine MAXLOC_NM_JP2@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
*
      ...
      subroutine MAXLOC_NM_SP2@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
