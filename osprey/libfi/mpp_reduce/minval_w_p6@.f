...
C
      ...
      subroutine MINVAL_W_JP6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_w_p6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            the Fortran routine MINVAL_I_JP6@.
*
...
************************************************************************
      ...
      integer local_min(lmext(1),lmext(2),lmext(3),lmext(4),lmext(5))
*
cdir$ parallel_only
...
cdir$ doshared (i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5)
      ...
      do i2 = 1, rext(2)
      do i1 = 1, rext(1)
          result(i1,i2,i3,i4,i5) = HUGE_INT()
      enddo
      enddo
      enddo
      enddo
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4,i5) = HUGE_INT()
      enddo
      enddo
      enddo
      enddo
      enddo
*
      include "minval_w_6@.fh"
*
      return
      end


      subroutine MINVAL_W_SP6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
************************************************************************
*
...
*            mask. This routine handles integer source arrays of rank
*            6. It returns an array result. This routine is called by
*            the Fortran routine MINVAL_I_SP6@.
*
...
************************************************************************
      ...
      real local_min(lmext(1),lmext(2),lmext(3),lmext(4),lmext(5))
*
cdir$ parallel_only
cdir$ shared result(:block,:block,:block,:block,:block)
*
...
cdir$ doshared (i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5)
      ...
      do i2 = 1, rext(2)
      do i1 = 1, rext(1)
          result(i1,i2,i3,i4,i5) = HUGE_FLT()
      enddo
      enddo
      enddo
      enddo
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4,i5) = HUGE_FLT()
      enddo
      enddo
      enddo
      enddo
