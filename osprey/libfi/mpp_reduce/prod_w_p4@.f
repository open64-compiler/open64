...
C
      ...
      subroutine PROD_W_JP4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
* Purpose:   Compute the product of the elements identified by mask.
*            This routine handles integer source arrays of rank
*            4. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_JP4@.
*
...
*                      dimension dim.
*
* Variables: local_prod - integer array of rank 3: array of local products.
...
************************************************************************
      ...
      integer local_prod(lmext(1),lmext(2),lmext(3))
*
...
*
      ...
      subroutine PROD_W_SP4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            4. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SP4@.
*
...
************************************************************************
      ...
      real local_prod(lmext(1),lmext(2),lmext(3))
*
cdir$ shared result(:block,:block,:block)
*
*     Initialize the local and global result arrays
