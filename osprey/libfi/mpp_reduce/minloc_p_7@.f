...
C
      ...
      subroutine MINLOC_JP7@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/minloc_p_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer result(0:n$pes-1,7), maskflg, ext(7), local_idx(7)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(7), min_value(0:n$pes-1), in_parallel
      logical mask(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
      integer source(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
...
*
      ...
      subroutine MINLOC_SP7@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements identified by
...
************************************************************************
      ...
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(7), in_parallel
      logical mask(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
      real source(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
...
*
      ...
      subroutine MINLOC_NM_JP7@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:n$pes-1,7), ext(7), local_idx(7)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(7), min_value(0:n$pes-1), in_parallel
      integer source(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
...
*
      local_min = HUGE_INT()
      include "minloc_nomask_7@.fh"
*
      return
      end


      subroutine MINLOC_NM_SP7@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements in the array.
