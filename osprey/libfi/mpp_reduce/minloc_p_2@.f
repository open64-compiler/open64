...
C
      ...
      subroutine MINLOC_JP2@(fresult,source,mask,maskflg,extent)
*
CDIR$ ID "@(#) libfi/mpp_reduce/minloc_p_2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer result(0:n$pes-1,2), maskflg, extent(2), local_idx(2)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(2)
      logical mask(extent(1),extent(2)), in_parallel
      integer min_value(0:n$pes-1), source(extent(1),extent(2))
...
*
      ...
      subroutine MINLOC_SP2@(fresult,source,mask,maskflg,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx(2)
      logical mask(extent(1),extent(2)), in_parallel
      real min_value(0:n$pes-1), source(extent(1),extent(2))
...
*
      ...
      subroutine MINLOC_NM_JP2@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:n$pes-1,2), extent(2), local_idx(2)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(2)
      logical in_parallel
...
*
      ...
      subroutine MINLOC_NM_SP2@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements in the array.
