...
C
      ...
      subroutine COUNT_W_LP4@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,lmext,
     +                      dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LP4@.
*
...
*
cdir$ doshared (i3,i2,i1) on result(i1,i2,i3)
      do i3 = 1, rext(3)
      do i2 = 1, rext(2)
      do i1 = 1, rext(1)
          result(i1,i2,i3) = 0
