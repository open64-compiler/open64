...
C
      ...
      subroutine ALL_I_LP4@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_i_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ALL_LP4.
*
...
*
      include "setup_4@.fh"
*
      call ALL_W_LP4@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
