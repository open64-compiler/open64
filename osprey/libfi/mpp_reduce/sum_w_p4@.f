...
C
      ...
      subroutine SUM_W_JP4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/sum_w_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine SUM_I_JP4@.
*
...
*                      dimension dim.
*
* Variables: local_sum - integer array of rank 3: array of local sums.
...
************************************************************************
      ...
      integer local_sum(lmext(1),lmext(2),lmext(3))
*
cdir$ parallel_only
...
*
      ...
      subroutine SUM_W_SP4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            4. It returns an array result. This routine is called
*            by the Fortran routine SUM_I_SP4@.
*
...
************************************************************************
      ...
      real local_sum(lmext(1),lmext(2),lmext(3))
*
cdir$ parallel_only
cdir$ shared result(:block,:block,:block)
*
