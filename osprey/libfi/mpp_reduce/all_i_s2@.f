...
C
      ...
      subroutine ALL_I_LS2@(result,source,dim,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_i_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ALL_LS2.
*
...
*
      include "setup_2@.fh"
*
      call ALL_W_LS2@(result,source,dim,rext,loc_sext,
