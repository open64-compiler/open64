...
C
      ...
      subroutine SUM_I_JP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/sum_i_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*                      distributed block in each dimension.
*            lmext   - integer scalar: extent of the local sum array
...
*
      include "setup_2@.fh"
*
      call SUM_W_JP2@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine SUM_I_SP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Compute the sum of the elements identified by mask.
...
*
      include "setup_2@.fh"
*
      call SUM_W_SP2@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi,low,lmext, dist_cnt)
*
      return
      end
