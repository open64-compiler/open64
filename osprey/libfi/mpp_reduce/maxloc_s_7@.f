...
C
      ...
      subroutine MAXLOC_JS7@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_s_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer result(0:0,7), maskflg, ext(7), local_idx(7)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(7), max_value(0:0), in_parallel
...
*
      ...
      subroutine MAXLOC_SS7@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
*
      ...
      subroutine MAXLOC_NM_JS7@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:0,7), ext(7), local_idx(7)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(7), max_value(0:0), in_parallel
      integer source(ext(1),ext(2),ext(3),ext(4),ext(5),ext(6),ext(7))
...
*
      local_max = -HUGE_INT()
      include "maxloc_nomask_7@.fh"
*
      return
      end


      subroutine MAXLOC_NM_SS7@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
