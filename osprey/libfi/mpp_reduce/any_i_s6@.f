...
C
      ...
      subroutine ANY_I_LS6@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_i_s6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ANY_LS6.
*
...
*
      include "setup_6@.fh"
*
      call ANY_W_LS6@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
