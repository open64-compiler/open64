...
C
      ...
      subroutine COUNT_I_LP2@(result,source,dim,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_i_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _COUNT_LP2.
*
...
*
      include "setup_2@.fh"
*
      call COUNT_W_LP2@(result,source,dim,rext,loc_sext,
