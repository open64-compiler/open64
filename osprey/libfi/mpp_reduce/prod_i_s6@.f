...
C
      ...
      subroutine PROD_I_JS6@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_i_s6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      include "setup_6@.fh"
*
      call PROD_W_JS6@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine PROD_I_SS6@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Compute the product of the elements identified by mask.
...
*
      include "setup_6@.fh"
*
      call PROD_W_SS6@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi_r1,low_r1,hi_r2,low_r2,hi_r3,
     +                 low_r3,hi_r4,low_r4,hi_r5,low_r5,lmext,dist_cnt)
*
      return
