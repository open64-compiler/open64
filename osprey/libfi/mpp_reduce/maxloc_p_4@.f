...
C
      ...
      subroutine MAXLOC_JP4@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/maxloc_p_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer max_value(0:n$pes-1), source(ext(1),ext(2),ext(3),ext(4))
...
*
      ...
      subroutine MAXLOC_SP4@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx(4)
      logical mask(ext(1),ext(2),ext(3),ext(4)), in_parallel
      real max_value(0:n$pes-1), source(ext(1),ext(2),ext(3),ext(4))
...
*
      ...
      subroutine MAXLOC_NM_JP4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
*
      local_max = -HUGE_INT()
      include "maxloc_nomask_4@.fh"
*
      return
      end


      subroutine MAXLOC_NM_SP4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the maximum value of the elements in the array.
