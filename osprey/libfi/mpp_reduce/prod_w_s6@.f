...
C
      ...
      subroutine PROD_W_JS6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_s6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine PROD_I_JS6@.
*
...
*
      ...
      subroutine PROD_W_SS6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            6. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SS6@.
*
