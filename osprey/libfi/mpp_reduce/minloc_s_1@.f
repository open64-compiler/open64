...
C
      ...
      subroutine MINLOC_JS1@(fresult,source,mask,maskflg,extent)
*
CDIR$ ID "@(#) libfi/mpp_reduce/minloc_s_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
************************************************************************
      ...
      integer result(0:0), maskflg, extent, local_idx
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx
      logical mask(extent), in_parallel
      integer min_value(0:0), source(extent), local_min, far_min
      integer HUGE_INT
*
...
*
      ...
      subroutine MINLOC_SS1@(fresult,source,mask,maskflg,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx
      logical mask(extent), in_parallel
      real min_value(0:0), source(extent), local_min, far_min
      real HUGE_FLT
*
cdir$ unknown_shared source, mask
*
...
*
      ...
      subroutine MINLOC_NM_JS1@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:0), extent, local_idx
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx
      logical in_parallel
...
*
      ...
      subroutine MINLOC_NM_SS1@(fresult,source,extent)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements in the array.
