...
C
      ...
      subroutine ANY_I_LS4@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_i_s4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ANY_LS4.
*
...
*
      include "setup_4@.fh"
*
      call ANY_W_LS4@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
