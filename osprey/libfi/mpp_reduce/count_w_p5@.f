...
C
      ...
      subroutine COUNT_W_LP5@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,hi4,
     +                      low4,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_p5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LP5@.
*
