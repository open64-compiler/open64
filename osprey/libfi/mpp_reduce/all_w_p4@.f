...
C
      ...
      subroutine ALL_W_LP4@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,lmext,
     +                      dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_w_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ALL_I_LP4@.
*
