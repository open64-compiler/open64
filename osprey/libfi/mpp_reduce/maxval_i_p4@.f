...
C
      ...
      subroutine MAXVAL_I_JP4@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/maxval_i_p4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      include "setup_4@.fh"
*
      call MAXVAL_W_JP4@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine MAXVAL_I_SP4@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Find the maximum value of the elements identified by
...
*
      include "setup_4@.fh"
*
      call MAXVAL_W_SP4@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi_r1,low_r1,hi_r2,low_r2,hi_r3,
     +                 low_r3,lmext,dist_cnt)
*
      return
