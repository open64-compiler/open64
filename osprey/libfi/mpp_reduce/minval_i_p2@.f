...
C
      ...
      subroutine MINVAL_I_JP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_i_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*                      distributed block in each dimension.
*            lmext   - integer scalar: extent of the local-minimum array
...
*
      include "setup_2@.fh"
*
      call MINVAL_W_JP2@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine MINVAL_I_SP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Find the minimum value of the elements identified by
...
*
      include "setup_2@.fh"
*
      call MINVAL_W_SP2@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi,low,lmext,dist_cnt)
*
      return
      end
