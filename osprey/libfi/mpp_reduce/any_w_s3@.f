...
C
      ...
      subroutine ANY_W_LS3@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_w_s3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ANY_I_LS3@.
*
...
*                      dimension dim.
*
* Variables: local_any - logical array of rank 2: array of local any values.
...
************************************************************************
      ...
      logical result(rext(1),rext(2)), local_any(lmext(1),lmext(2))
