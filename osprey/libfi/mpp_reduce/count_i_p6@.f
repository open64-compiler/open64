...
C
      ...
      subroutine COUNT_I_LP6@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_i_p6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _COUNT_LP6.
*
...
*                      extents of the local-cnt array if called within
...
************************************************************************
      ...
      integer dim, dim_bcnt(5), dist_cnt
...
*
      include "setup_6@.fh"
*
      call COUNT_W_LP6@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
     +                hi_r1,low_r1,hi_r2,low_r2,hi_r3,low_r3,hi_r4,
     +                low_r4,hi_r5,low_r5,lmext,dist_cnt)
*
      return
      end
