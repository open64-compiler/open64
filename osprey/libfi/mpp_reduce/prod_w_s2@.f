...
C
      ...
      subroutine PROD_W_JS2@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnt,npes,hi,low,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine PROD_I_JS2@.
*
...
*
      ...
      subroutine PROD_W_SS2@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnt,npes,hi,low,lmext,dist_cnt)
************************************************************************
*
* Purpose:   Compute the product of the elements identified by mask.
...
*            2. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SS2@.
*
