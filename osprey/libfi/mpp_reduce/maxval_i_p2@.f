...
C
      ...
      subroutine MAXVAL_I_JP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/maxval_i_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      include "setup_2@.fh"
*
      call MAXVAL_W_JP2@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine MAXVAL_I_SP2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Find the maximum value of the elements identified by
...
*
      include "setup_2@.fh"
*
      call MAXVAL_W_SP2@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi,low,lmext, dist_cnt)
*
      return
      end
