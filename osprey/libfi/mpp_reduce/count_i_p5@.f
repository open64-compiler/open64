...
C
      ...
      subroutine COUNT_I_LP5@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_i_p5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _COUNT_LP5.
*
...
************************************************************************
      ...
      integer dim, dim_bcnt(4), dist_cnt
...
*
      include "setup_5@.fh"
*
      call COUNT_W_LP5@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
     +                hi_r1,low_r1,hi_r2,low_r2,hi_r3,low_r3,hi_r4,
     +                low_r4,lmext,dist_cnt)
*
      return
      end
