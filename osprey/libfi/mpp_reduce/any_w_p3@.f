...
C
      ...
      subroutine ANY_W_LP3@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/any_w_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ANY_I_LP3@.
*
