...
C
      ...
      subroutine ALL_W_LP7@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,hi4,
     +                      low4,hi5,low5,hi6,low6,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_w_p7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine ALL_I_LP7@.
*
...
*                      dimension dim.
*
* Variables: local_all - logical array of rank 6: array of local all values.
...
cdir$ doshared (i6,i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5,i6)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_all(i1,i2,i3,i4,i5,i6) = .true.
      enddo
      enddo
      enddo
      enddo
