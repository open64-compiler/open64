...
C
      ...
      subroutine MINVAL_W_JS6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_w_s6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            the Fortran routine MINVAL_I_JS6@.
*
...
*
      ...
      subroutine MINVAL_W_SS6@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,lmext,dist_cnt)
************************************************************************
*
...
*            mask. This routine handles integer source arrays of rank
*            6. It returns an array result. This routine is called by
*            the Fortran routine MINVAL_I_SS6@.
*
