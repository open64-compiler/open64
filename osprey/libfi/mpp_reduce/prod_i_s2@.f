...
C
      ...
      subroutine PROD_I_JS2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_i_s2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*                      distributed block in each dimension.
*            lmext   - integer scalar: extent of the local product array
...
*
      include "setup_2@.fh"
*
      call PROD_W_JS2@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine PROD_I_SS2@(result,source,dim,mask,maskflg,rext,sext,
     +                       blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Compute the product of the elements identified by mask.
...
*
      include "setup_2@.fh"
*
      call PROD_W_SS2@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi,low,lmext,dist_cnt)
*
      return
      end
