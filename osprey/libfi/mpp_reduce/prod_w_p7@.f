...
C
      ...
      subroutine PROD_W_JP7@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,hi6,low6,lmext,
     +                   dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_p7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
* Purpose:   Compute the product of the elements identified by mask.
*            This routine handles integer source arrays of rank
*            7. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_JP7@.
*
...
*                      dimension dim.
*
* Variables: local_prod - integer array of rank 6: array of local products.
...
************************************************************************
     ...
     +               sext(6),sext(7))
      ...
      integer local_prod(lmext(1),lmext(2),lmext(3),lmext(4),lmext(5),
     +                  lmext(6))
*
...
cdir$ doshared (i6,i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5,i6)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_prod(i1,i2,i3,i4,i5,i6) = 1
      enddo
      enddo
      enddo
      enddo
...
*
      ...
      subroutine PROD_W_SP7@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,hi5,low5,hi6,low6,lmext,
     +                   dist_cnt)
************************************************************************
...
*            This routine handles integer source arrays of rank
*            7. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SP7@.
*
...
************************************************************************
     ...
     +             sext(6),sext(7))
      ...
      real local_prod(lmext(1),lmext(2),lmext(3),lmext(4),lmext(5),
     +               lmext(6))
*
cdir$ shared result(:block,:block,:block,:block,:block,:block)
*
...
cdir$ doshared (i6,i5,i4,i3,i2,i1) on result(i1,i2,i3,i4,i5,i6)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_prod(i1,i2,i3,i4,i5,i6) = 1.0
      enddo
      enddo
      enddo
      enddo
