...
C
      ...
      subroutine ALL_I_LP3@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_i_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ALL_LP3.
*
...
************************************************************************
      ...
      integer blkcnts(3), npes, mype, dist_cnt
      integer dim, dim_bcnt(2)
...
*
      include "setup_3@.fh"
*
      call ALL_W_LP3@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
     +                hi_r1,low_r1,hi_r2,low_r2,lmext,dist_cnt)
*
      return
      end
