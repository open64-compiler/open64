...
C
      ...
      subroutine SUM_W_JP3@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,lmext,
     +                   dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/sum_w_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine SUM_I_JP3@.
*
...
*
      ...
      subroutine SUM_W_SP3@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,lmext,
     +                   dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            3. It returns an array result. This routine is called
*            by the Fortran routine SUM_I_SP3@.
*
