...
C
      ...
      subroutine COUNT_W_LS6@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,hi4,
     +                      low4,hi5,low5,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_s6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LS6@.
*
...
*                      dimension dim.
*
* Variables: local_cnt - integer array of rank 5: array of local count
*                      of true elements.
...
************************************************************************
      ...
      integer local_cnt(lmext(1),lmext(2),lmext(3),lmext(4),lmext(5))
