...
C
      ...
      subroutine MINLOC_JS4@(fresult,source,mask,maskflg,ext)
*
CDIR$ ID "@(#) libfi/mpp_reduce/minloc_s_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*
      ...
      subroutine MINLOC_SS4@(fresult,source,mask,maskflg,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements identified by
...
************************************************************************
      ...
      integer tripcnt, far_idx(4)
      logical mask(ext(1),ext(2),ext(3),ext(4)), in_parallel
      real min_value(0:0), source(ext(1),ext(2),ext(3),ext(4))
...
*
      ...
      subroutine MINLOC_NM_JS4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
...
************************************************************************
      intrinsic my_pe, in_parallel
      integer result(0:0,4), ext(4), local_idx(4)
      integer fresult(8)
      integer mod_factor, offset, mype
      integer tripcnt, far_idx(4)
      logical in_parallel
...
*
      ...
      subroutine MINLOC_NM_SS4@(fresult,source,ext)
************************************************************************
*
* Purpose: Determine the location of the first element of source
*          having the minimum value of the elements in the array.
