...
C
      ...
      subroutine PROD_W_JS4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_s4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine PROD_I_JS4@.
*
...
*
      ...
      subroutine PROD_W_SS4@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,lmext,dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            4. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SS4@.
*
