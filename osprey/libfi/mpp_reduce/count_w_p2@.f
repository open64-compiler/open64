...
C
      ...
      subroutine COUNT_W_LP2@(result,source,dim,rext,sext,blkcnt,
     +                      npes,hi,low,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_p2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LP2@.
*
