...
C
      ...
      subroutine MINVAL_W_JP5@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,lmext,dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/minval_w_p5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            the Fortran routine MINVAL_I_JP5@.
*
...
************************************************************************
      ...
      integer local_min(lmext(1),lmext(2),lmext(3),lmext(4))
*
cdir$ parallel_only
...
cdir$ doshared (i4,i3,i2,i1) on result(i1,i2,i3,i4)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4) = HUGE_INT()
      enddo
      enddo
      enddo
      enddo
*
      include "minval_w_5@.fh"
*
      return
      end


      subroutine MINVAL_W_SP5@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,hi3,
     +                   low3,hi4,low4,lmext,dist_cnt)
************************************************************************
*
...
*            mask. This routine handles integer source arrays of rank
*            5. It returns an array result. This routine is called by
*            the Fortran routine MINVAL_I_SP5@.
*
...
************************************************************************
      ...
      real local_min(lmext(1),lmext(2),lmext(3),lmext(4))
*
cdir$ parallel_only
cdir$ shared result(:block,:block,:block,:block)
*
...
cdir$ doshared (i4,i3,i2,i1) on result(i1,i2,i3,i4)
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_min(i1,i2,i3,i4) = HUGE_FLT()
      enddo
      enddo
      enddo
      enddo
