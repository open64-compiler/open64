...
C
      ...
      subroutine MAXVAL_I_JP3@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/maxval_i_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*                      each dimension.
*            dim_bcnt- integer array of rank 1: number of blocks in all
*                      dimensions excluding dimension dim.
*
...
*
      include "setup_3@.fh"
*
      call MAXVAL_W_JP3@(result,source,dim,mask,maskflg,rext,loc_sext,
...
*
      ...
      subroutine MAXVAL_I_SP3@(result,source,dim,mask,maskflg,rext,
     +                       sext,blkcnts,dim_bcnt)
************************************************************************
*
* Purpose:   Find the maximum value of the elements identified by
...
*                      each dimension.
*            dim_bcnt- integer array or rank 1: number of blocks for
...
*
      include "setup_3@.fh"
*
      call MAXVAL_W_SP3@(result,source,dim,mask,maskflg,rext,loc_sext,
     +                 dim_bcnt,npes,hi_r1,low_r1,hi_r2,low_r2,lmext,
     +                 dist_cnt)
*
      return
