...
C
      ...
      subroutine COUNT_W_LS4@(result,source,dim,rext,sext,blkcnts,
     +                      npes,hi1,low1,hi2,low2,hi3,low3,lmext,
     +                      dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/count_w_s4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the Fortran routine COUNT_I_LS4@.
*
...
*                      dimension dim.
*
* Variables: local_cnt - integer array of rank 3: array of local count
*                      of true elements.
...
************************************************************************
      ...
      integer local_cnt(lmext(1),lmext(2),lmext(3))
...
*
      ...
      do i2 = 1, lmext(2)
      do i1 = 1, lmext(1)
          local_cnt(i1,i2,i3) = 0
      enddo
      enddo
      enddo
*
      include "count_w_4@.fh"
*
      return
      end
