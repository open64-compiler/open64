...
C
      ...
      subroutine ALL_I_LS5@(result,source,dim,rext,sext,
     +                      blkcnts,dim_bcnt)
CDIR$ ID "@(#) libfi/mpp_reduce/all_i_s5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            called by the C routine _ALL_LS5.
*
...
*
      include "setup_5@.fh"
*
      call ALL_W_LS5@(result,source,dim,rext,loc_sext,dim_bcnt,npes,
