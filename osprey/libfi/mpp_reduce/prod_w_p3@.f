...
C
      ...
      subroutine PROD_W_JP3@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,lmext,
     +                   dist_cnt)
CDIR$ ID "@(#) libfi/mpp_reduce/prod_w_p3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*            by the Fortran routine PROD_I_JP3@.
*
...
*                      dimension dim.
*
* Variables: local_prod - integer array of rank 2: array of local products.
...
************************************************************************
      ...
      integer result(rext(1),rext(2)), local_prod(lmext(1),lmext(2))
*
...
*
      ...
      subroutine PROD_W_SP3@(result,source,dim,mask,maskflg,rext,
     +                   sext,blkcnts,npes,hi1,low1,hi2,low2,lmext,
     +                   dist_cnt)
************************************************************************
*
...
*            This routine handles integer source arrays of rank
*            3. It returns an array result. This routine is called
*            by the Fortran routine PROD_I_SP3@.
*
...
************************************************************************
      ...
      real result(rext(1),rext(2)), local_prod(lmext(1),lmext(2))
*
cdir$ shared result(:block,:block)
*
*     Initialize the local and global result arrays
