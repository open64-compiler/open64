...
C
	...
	subroutine PREMAX_MASK_JP5@(result,source,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/premax_p_5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREMAX_JP5.
*
...
*
	...
	subroutine PREMAX_NOMASK_JP5@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREMAX_MASK_SP5@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements identified by mask,
...
*		This routine is called by the C routine _PREMAX_SP5.
*
...
*
	...
	subroutine PREMAX_NOMASK_SP5@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements in the array section,
