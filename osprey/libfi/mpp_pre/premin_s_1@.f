...
C
	...
	subroutine PREMIN_MASK_JS1@(result,source,dim,mask,sext)
*
CDIR$ ID "@(#) libfi/mpp_pre/premin_s_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREMIN_JS1.
*
...
*
	...
	subroutine PREMIN_NOMASK_JS1@(result,source,dim,sext)
*
************************************************************************
*
...
*
	...
	subroutine PREMIN_MASK_SS1@(result,source,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREMIN_SS1.
*
...
*
	...
	subroutine PREMIN_NOMASK_SS1@(result,source,dim,sext)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements in the array section,
...
!	subroutine PREMIN_SH_MASK_JS1@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine PREMIN_SH_NOMASK_JS1@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
...
!
!
!	subroutine PREMIN_SH_MASK_SS1@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine PREMIN_SH_NOMASK_SS1@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
