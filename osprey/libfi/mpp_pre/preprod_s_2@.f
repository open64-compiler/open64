...
C
	...
	subroutine PREPROD_MASK_JS2@(result,source,dim,mask,sext)
*
CDIR$ ID "@(#) libfi/mpp_pre/preprod_s_2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREPROD_JS2.
*
...
*
	if (dim .eq. 0) then
	    include "parapre_s2_dim0_mask.fh"
	else if (dim .eq. 1) then
	    include "parapre_s2_dim1_mask.fh"
	else
	    include "parapre_s2_dim2_mask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_NOMASK_JS2@(result,source,dim,sext)
*
************************************************************************
*
...
*
	if (dim .eq. 0) then
	    include "parapre_s2_dim0_nomask.fh"
	else if (dim .eq. 1) then
	    include "parapre_s2_dim1_nomask.fh"
	else
	    include "parapre_s2_dim2_nomask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_MASK_SS2@(result,source,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_SS2.
*
...
*
	...
	subroutine PREPROD_NOMASK_SS2@(result,source,dim,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
*
	...
	subroutine PREPROD_MASK_CS2@(result,source,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
*		while saving all intermediate results.  This routine handles
*		complex source arrays of rank 2. It returns an array result.
*		This routine is called by the C routine _PREPROD_CS2.
*
...
*
	...
	subroutine PREPROD_NOMASK_CS2@(result,source,dim,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine PREPROD_SH_MASK_JS2@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PREPROD_SH_NOMASK_JS2@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PREPROD_SH_MASK_SS2@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PREPROD_SH_NOMASK_SS2@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PREPROD_SH_MASK_CS2@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PREPROD_SH_NOMASK_CS2@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
