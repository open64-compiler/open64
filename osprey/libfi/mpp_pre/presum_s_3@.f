...
C
	...
	subroutine PRESUM_MASK_JS3@(result,source,dim,mask,sext)
*
CDIR$ ID "@(#) libfi/mpp_pre/presum_s_3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PRESUM_JS3.
*
...
*
	...
	subroutine PRESUM_NOMASK_JS3@(result,source,dim,sext)
*
************************************************************************
*
...
*
	...
	subroutine PRESUM_MASK_SS3@(result,source,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_SS3.
*
...
*
	...
	subroutine PRESUM_NOMASK_SS3@(result,source,dim,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
*
	...
	subroutine PRESUM_MASK_CS3@(result,source,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_CS3.
*
...
*
	...
	subroutine PRESUM_NOMASK_CS3@(result,source,dim,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine PRESUM_SH_MASK_JS3@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PRESUM_SH_NOMASK_JS3@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PRESUM_SH_MASK_SS3@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PRESUM_SH_NOMASK_SS3@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PRESUM_SH_NOMASK_CS3@(result,source,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PRESUM_SH_MASK_CS3@(result,source,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
