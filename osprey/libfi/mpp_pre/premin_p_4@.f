...
C
	...
	subroutine PREMIN_MASK_JP4@(result,source,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/premin_p_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREMIN_JP4.
*
...
*
	...
	subroutine PREMIN_NOMASK_JP4@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREMIN_MASK_SP4@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements identified by mask,
...
*		This routine is called by the C routine _PREMIN_SP4.
*
...
*
	...
	subroutine PREMIN_NOMASK_SP4@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements in the array section,
