...
C
	...
	subroutine PREMIN_MASK_JP7@(result,source,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/premin_p_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREMIN_JP7.
*
...
*
	...
	subroutine PREMIN_NOMASK_JP7@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREMIN_MASK_SP7@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements identified by mask,
...
*		This routine is called by the C routine _PREMIN_SP7.
*
...
*
	...
	subroutine PREMIN_NOMASK_SP7@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements in the array section,
