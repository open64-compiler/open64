...
C
	...
	subroutine PREPROD_MASK_JP6@(result,source,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/preprod_p_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREPROD_JP6.
*
...
*
	...
	subroutine PREPROD_NOMASK_JP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREPROD_MASK_SP6@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_SP6.
*
...
*
	...
	subroutine PREPROD_NOMASK_SP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
...
*
	...
	subroutine PREPROD_MASK_CP6@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_CP6.
*
...
*
	...
	subroutine PREPROD_NOMASK_CP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
