...
C
	...
	subroutine PRESUM_MASK_JP2@(result,source,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/presum_p_2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PRESUM_JP2.
*
...
*
	...
	subroutine PRESUM_NOMASK_JP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PRESUM_MASK_SP2@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_SP2.
*
...
*
	...
	subroutine PRESUM_NOMASK_SP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
...
*
	...
	subroutine PRESUM_MASK_CP2@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_CP2.
*
...
*
	...
	subroutine PRESUM_NOMASK_CP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
