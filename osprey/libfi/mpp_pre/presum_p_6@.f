...
C
	...
	subroutine PRESUM_MASK_JP6@(result,source,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/presum_p_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PRESUM_JP6.
*
...
*
	...
	subroutine PRESUM_NOMASK_JP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PRESUM_MASK_SP6@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_SP6.
*
...
*
	...
	subroutine PRESUM_NOMASK_SP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
...
*
	...
	subroutine PRESUM_MASK_CP6@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _PRESUM_CP6.
*
...
*
	...
	subroutine PRESUM_NOMASK_CP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
