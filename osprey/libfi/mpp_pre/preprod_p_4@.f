...
C
	...
	subroutine PREPROD_MASK_JP4@(result,source,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/preprod_p_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREPROD_JP4.
*
...
*
	...
	subroutine PREPROD_NOMASK_JP4@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREPROD_MASK_SP4@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_SP4.
*
...
*
	...
	subroutine PREPROD_NOMASK_SP4@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
...
*
	...
	subroutine PREPROD_MASK_CP4@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_CP4.
*
...
*
	...
	subroutine PREPROD_NOMASK_CP4@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
