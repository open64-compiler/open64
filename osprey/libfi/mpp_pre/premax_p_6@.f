...
C
	...
	subroutine PREMAX_MASK_JP6@(result,source,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/premax_p_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREMAX_JP6.
*
...
*
	...
	subroutine PREMAX_NOMASK_JP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine PREMAX_MASK_SP6@(result,source,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements identified by mask,
...
*		This routine is called by the C routine _PREMAX_SP6.
*
...
*
	...
	subroutine PREMAX_NOMASK_SP6@(result,source,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements in the array section,
