...
C
	...
	subroutine PREPROD_MASK_JS6@(result,source,dim,mask,sx)
*
CDIR$ ID "@(#) libfi/mpp_pre/preprod_s_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREPROD_JS6.
*
...
*
	if (dim .eq. 0) then
	    include "parapre_s6_dim0_mask.fh"
	else if (dim .eq. 1) then
	    include "parapre_s6_dim1_mask.fh"
	else if (dim .eq. 2) then
	    include "parapre_s6_dim2_mask.fh"
	else if (dim .eq. 3) then
	    include "parapre_s6_dim3_mask.fh"
	else if (dim .eq. 4) then
	    include "parapre_s6_dim4_mask.fh"
	else if (dim .eq. 5) then
	    include "parapre_s6_dim5_mask.fh"
	else
	    include "parapre_s6_dim6_mask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_NOMASK_JS6@(result,source,dim,sx)
*
************************************************************************
*
...
*
	if (dim .eq. 0) then
	    include "parapre_s6_dim0_nomask.fh"
	else if (dim .eq. 1) then
	    include "parapre_s6_dim1_nomask.fh"
	else if (dim .eq. 2) then
	    include "parapre_s6_dim2_nomask.fh"
	else if (dim .eq. 3) then
	    include "parapre_s6_dim3_nomask.fh"
	else if (dim .eq. 4) then
	    include "parapre_s6_dim4_nomask.fh"
	else if (dim .eq. 5) then
	    include "parapre_s6_dim5_nomask.fh"
	else
	    include "parapre_s6_dim6_nomask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_MASK_SS6@(result,source,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_SS6.
*
...
*
	...
	subroutine PREPROD_NOMASK_SS6@(result,source,dim,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
*
	...
	subroutine PREPROD_MASK_CS6@(result,source,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_CS6.
*
...
*
	...
	subroutine PREPROD_NOMASK_CS6@(result,source,dim,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine PREPROD_SH_MASK_JS6@(result,source,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PREPROD_SH_NOMASK_JS6@(result,source,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PREPROD_SH_MASK_SS6@(result,source,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine PREPROD_SH_NOMASK_SS6@(result,source,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PREPROD_SH_NOMASK_CS6@(result,source,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine PREPROD_SH_MASK_CS6@(result,source,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
