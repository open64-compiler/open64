...
C
	...
	subroutine PREPROD_MASK_JP2@(result,source,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_pre/preprod_p_2@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _PREPROD_JP2.
*
...
*
	if (dim .eq. 0) then
	    include "parapre_p2_dim0_mask.fh"
	else if (dim .eq. 1) then
	    include "parapre_p2_dim1_mask.fh"
	else
	    include "parapre_p2_dim2_mask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_NOMASK_JP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	if (dim .eq. 0) then
	    include "parapre_p2_dim0_nomask.fh"
	else if (dim .eq. 1) then
	    include "parapre_p2_dim1_nomask.fh"
	else
	    include "parapre_p2_dim2_nomask.fh"
	endif
*
	return
	end
	...
	subroutine PREPROD_MASK_SP2@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_SP2.
*
...
*
	...
	subroutine PREPROD_NOMASK_SP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
*
	...
	subroutine PREPROD_MASK_CP2@(result,source,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _PREPROD_CP2.
*
...
*
	...
	subroutine PREPROD_NOMASK_CP2@(result,source,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
