...
C
	...
	subroutine eoshift_wd1_p1@(result, source, shift, bound, dim,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
CDIR$ ID "@(#) libfi/mpp_shift/eoshift_p_1@.f	92.0	10/08/98 14:37:14"
*
**************************************************************************
*
...
*
	include "eoshift_p1_dim1@.fh"
*
	return
	end


	subroutine eoshift_wd2_p1@(result, source, shift, bound, dim,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
