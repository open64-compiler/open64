...
C
	...
	subroutine eoshift_wd1_p2@(result, source, shift, bound, dim,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
CDIR$ ID "@(#) libfi/mpp_shift/eoshift_p_2@.f	92.0	10/08/98 14:37:14"
*
**************************************************************************
*
...
*
	if (dim .eq. 1) then
	    call eoshift_wd1_p2_dim1@ (result, source, shift, bound, sext,
     &			shext, bext, shflag, shftval, bndflag, bndval)
	else
	    call eoshift_wd1_p2_dim2@ (result, source, shift, bound, sext,
     &			shext, bext, shflag, shftval, bndflag, bndval)
	endif
*
	return
	...
	subroutine eoshift_wd2_p2@(result, source, shift, bound, dim,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	if (dim .eq. 1) then
	    call eoshift_wd2_p2_dim1@ (result, source, shift, bound, sext,
     &			shext, bext, shflag, shftval, bndflag, bndval)
	else
	    call eoshift_wd2_p2_dim2@ (result, source, shift, bound, sext,
     &			shext, bext, shflag, shftval, bndflag, bndval)
	endif
*
	return
	...
	subroutine eoshift_wd1_p2_dim1@(result, source, shift, bound,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
!cdir$	shared		result(:block,:block)
*
	include "eoshift_p2_dim1@.fh"
*
	return
	end

	subroutine eoshift_wd1_p2_dim2@(result, source, shift, bound,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
!cdir$	shared		result(:block,:block)
*
	include "eoshift_p2_dim2@.fh"
*
	return
	end


	subroutine eoshift_wd2_p2_dim1@(result, source, shift, bound,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	...
	subroutine eoshift_wd2_p2_dim2@(result, source, shift, bound,
     *		sext, shext, bext, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
