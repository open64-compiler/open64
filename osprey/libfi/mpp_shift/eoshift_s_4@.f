...
C
	...
	subroutine eoshift_wd1_s4@(result, source, shift, bound, dim,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
CDIR$ ID "@(#) libfi/mpp_shift/eoshift_s_4@.f	92.0	10/08/98 14:37:14"
*
**************************************************************************
*
...
*
	if (dim .eq. 1) then
	    call eoshift_wd1_s4_dim1@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else if (dim .eq. 2) then
	    call eoshift_wd1_s4_dim2@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else if (dim .eq. 3) then
	    call eoshift_wd1_s4_dim3@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else
	    call eoshift_wd1_s4_dim4@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	endif
*
	return
	...
	subroutine eoshift_wd1_s4_dim1@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
cdir$	unknown_shared	source, shift, bound
*
	include "eoshift_s4_dim1@.fh"
*
	return
	end


	subroutine eoshift_wd1_s4_dim2@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
cdir$	unknown_shared	source, shift, bound
*
	include "eoshift_s4_dim2@.fh"
*
	return
	end


	subroutine eoshift_wd1_s4_dim3@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
cdir$	unknown_shared	source, shift, bound
*
	include "eoshift_s4_dim3@.fh"
*
	return
	end


	subroutine eoshift_wd1_s4_dim4@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
cdir$	unknown_shared	source, shift, bound
*
	include "eoshift_s4_dim4@.fh"
*
	return
	end


	subroutine eoshift_wd2_s4@(result, source, shift, bound, dim,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	if (dim .eq. 1) then
	    call eoshift_wd2_s4_dim1@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else if (dim .eq. 2) then
	    call eoshift_wd2_s4_dim2@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else if (dim .eq. 3) then
	    call eoshift_wd2_s4_dim3@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	else
	    call eoshift_wd2_s4_dim4@ (result, source, shift, bound,
     &		sx, shx, bx, shflag, shftval, bndflag, bndval)
	endif
*
	return
	...
	subroutine eoshift_wd2_s4_dim1@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	...
	subroutine eoshift_wd2_s4_dim2@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	...
	subroutine eoshift_wd2_s4_dim3@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
...
*
	...
	subroutine eoshift_wd2_s4_dim4@(result, source, shift, bound,
     *		sx, shx, bx, shflag, shftval, bndflag, bndval)
*
**************************************************************************
*
