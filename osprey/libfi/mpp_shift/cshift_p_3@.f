...
C
	...
	subroutine cshift_wd1_p3@(result, source, shift, dim,
     &		sext, shext, shflag, shftval)
*
CDIR$ ID "@(#) libfi/mpp_shift/cshift_p_3@.f	92.0	10/08/98 14:37:14"
*
**************************************************************************
*
...
*
	if (dim .eq. 1) then
	    include "cshift_p3_dim1@.fh"
	else if (dim .eq. 2) then
	    include "cshift_p3_dim2@.fh"
	else
	    include "cshift_p3_dim3@.fh"
	endif
cdir$	barrier
*
	return
	...
	subroutine cshift_wd2_p3@(result, source, shift, dim,
     &		sext, shext, shflag, shftval)
*
**************************************************************************
*
