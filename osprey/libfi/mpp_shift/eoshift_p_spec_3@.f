...
C
	...
	subroutine eoshift_spec_wd1_p3@(result, source, dim, sext, shftval,
     &		bndval)
*
CDIR$ ID "@(#) libfi/mpp_shift/eoshift_p_spec_3@.f	92.0	"
...
*
	    call eoshift_spec_i_wd1_p3@ (result, source, dim, sext, shftval,
...
*
	...
	subroutine eoshift_spec_i_wd1_p3@ (result, source, dim, sext, shftval, 
     &		bndval, blksize, pe_low, pe_hi)
*
**************************************************************************
*
...
*
	call eoshift_spec_w_wd1_p3@ (result(1,1,1), source(1,1,1), dim, 
     &		blksize, shftval, bndval, pe_low, pe_hi)
*
	return
	end


	subroutine eoshift_spec_w_wd1_p3@ (result, source, dim, sext, shftval,
     &		bndval, pe_low, pe_hi)
*
**************************************************************************
*
...
*
	...
	totsx3 = sext(3)
	str1 = 1
	include "eoshift_spec_3@.fh"
*
	return
	end


	subroutine eoshift_spec_wd2_p3@(result, source, dim, sext, shftval,
     &		bndval)
*
**************************************************************************
*
...
*
	    call eoshift_spec_i_wd2_p3@ (result, source, dim, sext, shftval,
     &		bndval, blksize, pe_low, pe_hi)
	endif
*
cdir$	barrier
...
*
	...
	subroutine eoshift_spec_i_wd2_p3@ (result, source, dim, sext, shftval, 
     &		bndval, blksize, pe_low, pe_hi)
*
**************************************************************************
*
...
cdir$	pe_resident	source, result
*
	call eoshift_spec_w_wd2_p3@ (result(1,1,1), source(1,1,1), dim,
     &		blksize, shftval, bndval, pe_low, pe_hi)
*
	return
	end
	...
	subroutine eoshift_spec_w_wd2_p3@ (result, source, dim, sext,
