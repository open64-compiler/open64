...
C
	...
	subroutine SCANSUM_MASK_JP1@(result,source,stop,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scansum_p_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANSUM_JP1.
*
...
cdir$	barrier
	...
	subroutine SCANSUM_NOMASK_JP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
...
cdir$	barrier
	...
	subroutine SCANSUM_MASK_SP1@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_SP1.
*
...
cdir$	barrier
	...
	subroutine SCANSUM_NOMASK_SP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
...
cdir$	barrier
	...
	subroutine SCANSUM_MASK_CP1@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_CP1.
*
...
cdir$	barrier
	...
	subroutine SCANSUM_NOMASK_CP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
