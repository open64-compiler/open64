...
C
	...
	subroutine SCANMIN_MASK_JS6@(result,source,stop,dim,mask,sx)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmin_s_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMIN_JS6.
*
...
*
	...
	subroutine SCANMIN_NOMASK_JS6@(result,source,stop,dim,sx)
*
************************************************************************
*
...
*
	...
	subroutine SCANMIN_MASK_SS6@(result,source,stop,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMIN_SS6.
*
...
*
	...
	subroutine SCANMIN_NOMASK_SS6@(result,source,stop,dim,sx)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements in the array section,
...
!	subroutine SCANMIN_SH_MASK_JS6@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine SCANMIN_SH_NOMASK_JS6@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
...
!
!
!	subroutine SCANMIN_SH_MASK_SS6@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine SCANMIN_SH_NOMASK_SS6@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
