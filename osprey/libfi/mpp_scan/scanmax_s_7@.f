...
C
	...
	subroutine SCANMAX_MASK_JS7@(result,source,stop,dim,mask,sx)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmax_s_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMAX_JS7.
*
...
*
	...
	subroutine SCANMAX_NOMASK_JS7@(result,source,stop,dim,sx)
*
************************************************************************
*
...
*
	...
	subroutine SCANMAX_MASK_SS7@(result,source,stop,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMAX_SS7.
*
...
*
	...
	subroutine SCANMAX_NOMASK_SS7@(result,source,stop,dim,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine SCANMAX_SH_MASK_JS7@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANMAX_SH_NOMASK_JS7@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine SCANMAX_SH_MASK_SS7@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANMAX_SH_NOMASK_SS7@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
