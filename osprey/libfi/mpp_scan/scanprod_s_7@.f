...
C
	...
	subroutine SCANPROD_MASK_JS7@(result,source,stop,dim,mask,sx)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanprod_s_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANPROD_JS7.
*
...
*
	...
	subroutine SCANPROD_NOMASK_JS7@(result,source,stop,dim,sx)
*
************************************************************************
*
...
*
	...
	subroutine SCANPROD_MASK_SS7@(result,source,stop,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_SS7.
*
...
*
	...
	subroutine SCANPROD_NOMASK_SS7@(result,source,stop,dim,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
*
	...
	subroutine SCANPROD_MASK_CS7@(result,source,stop,dim,mask,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_CS7.
*
...
*
	...
	subroutine SCANPROD_NOMASK_CS7@(result,source,stop,dim,sx)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine SCANPROD_SH_MASK_JS7@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANPROD_SH_NOMASK_JS7@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine SCANPROD_SH_MASK_SS7@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANPROD_SH_NOMASK_SS7@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine SCANPROD_SH_NOMASK_CS7@(result,source,stop,dim,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine SCANPROD_SH_MASK_CS7@(result,source,stop,dim,mask,sx)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
