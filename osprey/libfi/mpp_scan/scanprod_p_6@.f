...
C
	...
	subroutine SCANPROD_MASK_JP6@(result,source,stop,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanprod_p_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANPROD_JP6.
*
...
*
	...
	subroutine SCANPROD_NOMASK_JP6@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANPROD_MASK_SP6@(result,source,stop,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_SP6.
*
...
*
	...
	subroutine SCANPROD_NOMASK_SP6@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
...
*
	...
	subroutine SCANPROD_MASK_CP6@(result,source,stop,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_CP6.
*
...
*
	...
	subroutine SCANPROD_NOMASK_CP6@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the product of the elements in the array section,
