...
C
	...
	subroutine SCANMAX_MASK_JP3@(result,source,stop,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmax_p_3@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMAX_JP3.
*
...
*
	...
	subroutine SCANMAX_NOMASK_JP3@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANMAX_MASK_SP3@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMAX_SP3.
*
...
*
	...
	subroutine SCANMAX_NOMASK_SP3@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
