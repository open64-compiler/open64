...
C
	...
	subroutine SCANPROD_MASK_JP1@(result,source,stop,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanprod_p_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANPROD_JP1.
*
...
cdir$	barrier
*
	include "segscan_p1_dim0_mask.fh"
*
cdir$	barrier
	return
	end
	...
	subroutine SCANPROD_NOMASK_JP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
...
cdir$	barrier
*
	include "segscan_p1_dim0_nomask.fh"
*
cdir$	barrier
	...
	subroutine SCANPROD_MASK_SP1@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_SP1.
*
...
cdir$	barrier
	...
	subroutine SCANPROD_NOMASK_SP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
cdir$	barrier
	...
	subroutine SCANPROD_MASK_CP1@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANPROD_CP1.
*
...
cdir$	barrier
	...
	subroutine SCANPROD_NOMASK_CP1@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
