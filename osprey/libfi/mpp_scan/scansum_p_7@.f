...
C
	...
	subroutine SCANSUM_MASK_JP7@(result,source,stop,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scansum_p_7@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANSUM_JP7.
*
...
*
	...
	subroutine SCANSUM_NOMASK_JP7@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANSUM_MASK_SP7@(result,source,stop,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_SP7.
*
...
*
	...
	subroutine SCANSUM_NOMASK_SP7@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
...
*
	...
	subroutine SCANSUM_MASK_CP7@(result,source,stop,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_CP7.
*
...
*
	...
	subroutine SCANSUM_NOMASK_CP7@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
