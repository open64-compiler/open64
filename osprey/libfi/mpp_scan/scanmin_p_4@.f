...
C
	...
	subroutine SCANMIN_MASK_JP4@(result,source,stop,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmin_p_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMIN_JP4.
*
...
*
	...
	subroutine SCANMIN_NOMASK_JP4@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANMIN_MASK_SP4@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMIN_SP4.
*
...
*
	...
	subroutine SCANMIN_NOMASK_SP4@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the minimum of the elements in the array section,
