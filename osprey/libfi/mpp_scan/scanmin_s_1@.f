...
C
	...
	subroutine SCANMIN_MASK_JS1@(result,source,stop,dim,mask,sext)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmin_s_1@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMIN_JS1.
*
...
*
	...
	subroutine SCANMIN_NOMASK_JS1@(result,source,stop,dim,sext)
*
************************************************************************
*
...
*
	...
	subroutine SCANMIN_MASK_SS1@(result,source,stop,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMIN_SS1.
*
...
*
	...
	subroutine SCANMIN_NOMASK_SS1@(result,source,stop,dim,sext)
*
************************************************************************
*
* Purpose:	Find the minimum value of the elements in the array section,
...
!	subroutine SCANMIN_SH_MASK_JS1@(result,source,stop,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine SCANMIN_SH_NOMASK_JS1@(result,source,stop,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
...
!
!
!	subroutine SCANMIN_SH_MASK_SS1@(result,source,stop,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements identified by mask,
...
!
!
!	subroutine SCANMIN_SH_NOMASK_SS1@(result,source,stop,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the minimum value of the elements in the array section,
