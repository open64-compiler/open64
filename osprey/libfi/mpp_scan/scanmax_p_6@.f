...
C
	...
	subroutine SCANMAX_MASK_JP6@(result,source,stop,dim,mask,sx,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmax_p_6@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMAX_JP6.
*
...
*
	...
	subroutine SCANMAX_NOMASK_JP6@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANMAX_MASK_SP6@(result,source,stop,dim,mask,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMAX_SP6.
*
...
*
	...
	subroutine SCANMAX_NOMASK_SP6@(result,source,stop,dim,sx,blkcnt)
*
************************************************************************
*
* Purpose:	Find the maximum of the elements in the array section,
