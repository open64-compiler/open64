...
C
	...
	subroutine SCANSUM_MASK_JP5@(result,source,stop,dim,mask,sext,blkcnt)
*
CDIR$ ID "@(#) libfi/mpp_scan/scansum_p_5@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANSUM_JP5.
*
...
*
	...
	subroutine SCANSUM_NOMASK_JP5@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
...
*
	...
	subroutine SCANSUM_MASK_SP5@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_SP5.
*
...
*
	...
	subroutine SCANSUM_NOMASK_SP5@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
...
*
	...
	subroutine SCANSUM_MASK_CP5@(result,source,stop,dim,mask,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements identified by mask,
...
*		This routine is called by the C routine _SCANSUM_CP5.
*
...
*
	...
	subroutine SCANSUM_NOMASK_CP5@(result,source,stop,dim,sext,blkcnt)
*
************************************************************************
*
* Purpose:	Find the sum of the elements in the array section,
