...
C
	...
	subroutine SCANMAX_MASK_JS4@(result,source,stop,dim,mask,sext)
*
CDIR$ ID "@(#) libfi/mpp_scan/scanmax_s_4@.f	92.0	10/08/98 14:37:14"
************************************************************************
*
...
*		This routine is called by the C routine _SCANMAX_JS4.
*
...
*
	...
	subroutine SCANMAX_NOMASK_JS4@(result,source,stop,dim,sext)
*
************************************************************************
*
...
*
	...
	subroutine SCANMAX_MASK_SS4@(result,source,stop,dim,mask,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements identified by mask,
...
*		This routine is called by the C routine _SCANMAX_SS4.
*
...
*
	...
	subroutine SCANMAX_NOMASK_SS4@(result,source,stop,dim,sext)
*
************************************************************************
*
* Purpose:	Find the maximum value of the elements in the array section,
...
!	subroutine SCANMAX_SH_MASK_JS4@(result,source,stop,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANMAX_SH_NOMASK_JS4@(result,source,stop,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
...
!
!
!	subroutine SCANMAX_SH_MASK_SS4@(result,source,stop,dim,mask,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements identified by mask,
...
!
!
!	subroutine SCANMAX_SH_NOMASK_SS4@(result,source,stop,dim,sext)
!*
!************************************************************************
!*
!* Purpose:	Find the maximum value of the elements in the array section,
