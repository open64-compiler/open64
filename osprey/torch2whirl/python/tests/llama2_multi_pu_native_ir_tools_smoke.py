...
def _inspect_artifact(ir_b2a: Path, artifact: Path, text_dump: Path) -> int:
    ...
    required = [
        ...
        "decoder_input",
        "decoder_output",
        "IDNAME 0 <2,1,model_token_ids>",
        "IDNAME 0 <2,2,model_token_embedding_weight>",
        ...
        "context=TinyLlama2ForCausalLM.layers.0.attention.rotary.query",
        "source_ordinal=0",
        "context=TinyLlama2ForCausalLM.layers.0.attention.rotary.key",
        "source_ordinal=1",
        "instance=layers.0.attention_norm",
        "context=TinyLlama2ForCausalLM.layers.0.attention_norm",
        "instance=layers.0.attention",
        "context=TinyLlama2ForCausalLM.layers.0.attention",
        "source_ordinal=2",
        "instance=layers.0.ffn_norm",
        "context=TinyLlama2ForCausalLM.layers.0.ffn_norm",
        "source_ordinal=3",
        ...
        "DSL Callsite Metadata Table: version=1 entries=9",
    ...
    if text.count("__WHIRL_DSL_CALL__") < 9:
